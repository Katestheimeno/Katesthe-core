...
- [COMPLETED] [001-rsa-key-module.md](001-rsa-key-module.md) — RSA key management module (1.1)
- [COMPLETED] [002-pydantic-settings.md](002-pydantic-settings.md) — Pydantic settings JWT/Cookie/Throttle fields (1.2)
- [COMPLETED] [003-rs256-simplejwt-config.md](003-rs256-simplejwt-config.md) — SimpleJWT RS256 configuration (1.3)
- [COMPLETED] [004-kid-token-classes.md](004-kid-token-classes.md) — Kid token classes + issuance wiring (1.4)
- [COMPLETED] [005-generate-jwt-keys-command.md](005-generate-jwt-keys-command.md) — generate_jwt_keys management command (1.5)
- [COMPLETED] [006-jwks-endpoint.md](006-jwks-endpoint.md) — JWKS endpoint (1.6)
- [COMPLETED] [007-production-rs256-enforcement.md](007-production-rs256-enforcement.md) — Production RS256 enforcement + env examples (1.7)
- [COMPLETED] [008-throttle-base-classes.md](008-throttle-base-classes.md) — Throttle base classes (4.1)
- [COMPLETED] [009-throttle-rates.md](009-throttle-rates.md) — Throttle rates in REST_FRAMEWORK (4.2)
- [COMPLETED] [010-flush-throttles-command.md](010-flush-throttles-command.md) — Flush-throttles command (4.3)
- [COMPLETED] [011-cookie-jwt-authentication.md](011-cookie-jwt-authentication.md) — Cookie JWT authentication (2.1)
- [COMPLETED] [012-spectacular-auth-extension.md](012-spectacular-auth-extension.md) — Spectacular auth extension (2.2)
- [COMPLETED] [013-security-liveness-middleware.md](013-security-liveness-middleware.md) — Security-headers + liveness middleware (2.3+2.6)
- [COMPLETED] [014-enhanced-production-security.md](014-enhanced-production-security.md) — Enhanced production security (2.4)
- [COMPLETED] [015-timing-oracle-defense.md](015-timing-oracle-defense.md) — Timing-oracle defense in login (2.5)
- [COMPLETED] [016-session-revocation-service.md](016-session-revocation-service.md) — Session revocation service (3.1)
- [COMPLETED] [017-token-housekeeping-task.md](017-token-housekeeping-task.md) — Token housekeeping task + tasks package (3.2)
- [COMPLETED] [018-custom-jwt-claims.md](018-custom-jwt-claims.md) — Custom JWT claims / is_superuser exclusion (3.3)
- [COMPLETED] [019-privilege-change-revocation.md](019-privilege-change-revocation.md) — Privilege-change session revocation (3.4)
- [COMPLETED] [020-jwt-websocket-middleware.md](020-jwt-websocket-middleware.md) — JWT WebSocket auth middleware (5.1)
- [COMPLETED] [021-websocket-protocol-utils.md](021-websocket-protocol-utils.md) — WebSocket protocol utilities (5.2)
- [COMPLETED] [022-websocket-rate-limit-cors.md](022-websocket-rate-limit-cors.md) — WebSocket rate limiter + CORS header (5.3+5.4)
- [COMPLETED] [023-update-auth-tests.md](023-update-auth-tests.md) — Update existing auth tests/factories → RS256 + cookies
